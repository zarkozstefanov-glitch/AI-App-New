...
export default function ChangeCalculatorPage() {
  const { t } = useI18n();
  const [billEur, setBillEur] = useState("0.00");
  const [paidBgn, setPaidBgn] = useState("0.00");
  const [paidEur, setPaidEur] = useState("0.00");
            ...
            <div className="grid gap-4">
              <label className="text-sm text-slate-700">
                ...
                <input
                  ...
                  className="mt-2 w-full rounded-xl border border-slate-200 bg-white px-4 py-2 text-xl font-semibold text-slate-900 outline-none"
                />
              </label>
